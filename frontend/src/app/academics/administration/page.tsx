...
export default function AdministrationPage() {
    ...
    const decTrustees = getTrustees('DEC');
            ...
            <main className="flex-grow pt-32 pb-24">
                <div className="container mx-auto px-6 max-w-6xl">
                    ...
                    {decTrustees.length > 0 && (
                        <section className="mb-20">
                            <h2 className="text-3xl font-playfair font-bold text-blue-900 mb-10 text-center relative inline-block w-full">
                                <span className="relative z-10 bg-stone-50 px-6">DEC Trustees</span>
                                <div className="absolute top-1/2 left-0 w-full h-px bg-stone-300 -z-0"></div>
                            </h2>
                            <div className="flex flex-wrap justify-center gap-8">
...
function TrusteeCard({ trustee }: { trustee: Trustee }) {
    return (
        <div className="group h-[450px] w-full [perspective:1000px] bg-transparent">
            <div className="relative w-full h-full transition-all duration-700 [transform-style:preserve-3d] group-hover:[transform:rotateY(180deg)] group-hover:scale-105 shadow-sm hover:shadow-2xl">
                ...
                <div className="absolute inset-0 w-full h-full bg-white flex flex-col items-center p-6 border border-stone-200 [backface-visibility:hidden] overflow-hidden">
                    ...
                    <div className="absolute top-0 left-0 w-full h-1 bg-gradient-to-r from-red-700 to-blue-900"></div>
                    ...
                    <div className="mt-auto mb-4">
                         <span className="text-xs text-red-700 font-bold uppercase tracking-widest border-b border-red-700 pb-0.5">Read Biography</span>
                    </div>
                </div>
