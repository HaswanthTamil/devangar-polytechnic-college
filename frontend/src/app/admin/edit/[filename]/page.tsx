            ...
            <div className="max-w-5xl mx-auto">
                <header className="mb-12 flex flex-col md:flex-row justify-between items-start md:items-end gap-6">
                    <div>
                        ...
                        <h1 className="text-4xl font-playfair font-bold text-stone-900 mb-2">Editing <span className="text-red-700 italic">{filename != 'auth.json' && (filename == 'gallery.json' ? 'events' : filename.replace('.json', ''))}</span></h1>
